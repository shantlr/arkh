import { WorkflowActionHandlerDef, WorkflowActionHandlerMap } from "./types";
...
export const createLatests = <HandlerMap extends WorkflowActionHandlerMap<any>>(
  ...
  const res: Record<string, WorkflowActionHandlerDef<any>> = {};
  ...
  return res as {
    [key in keyof HandlerMap]: WorkflowActionHandlerDef<
      HandlerMap[key] extends WorkflowActionPromiseApiFn<infer A>
        ? A
        : HandlerMap[key] extends WorkflowActionHandlerDef<infer A>
        ? A
        : never
    >;
  };
